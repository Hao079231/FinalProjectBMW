...
<% HttpSession sessionCheck=request.getSession(false); if (sessionCheck==null ||
    sessionCheck.getAttribute("user")==null) {
    response.sendRedirect("signinup.jsp?status=login_required"); return; } Users user=(Users)
    sessionCheck.getAttribute("user"); if (!"admin".equals(user.getRole())) {
    response.sendRedirect("error.jsp?message=AccessDenied"); return; } %>
    <!DOCTYPE html>
    <html lang="en">
            ...
            <div class="max-w-7xl mx-auto px-4">
                <div class="flex justify-between">
                    ...
                    <form action="SignInUp" method="post" class="hidden md:flex items-center space-x-1">
                        ...
                        <button type="submit"
                            class="py-2 px-3 bg-orange-500 text-white rounded-full hover:bg-orange-600 transition-colors">
                            Logout
                        </button>
                    </form>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 py-6" id="main-content">
            ...
            <form method="post" action="Statistical" class="mb-6">
                <div class="flex space-x-4">
                    ...
                    <button type="submit" class="px-6 py-2 bg-blue-500 text-white rounded-lg">Thống
                        kê</button>
                </div>
            </form>
                ...
                <table class="min-w-full table-auto">
                    <thead>
                        <tr class="bg-gray-200">
                            ...
                            <th class="px-6 py-3 text-left text-sm font-medium text-gray-700">Họ tên
                            </th>
                            <th class="px-6 py-3 text-left text-sm font-medium text-gray-700">Địa chỉ
                            </th>
                            <th class="px-6 py-3 text-left text-sm font-medium text-gray-700">Điện thoại
                            </th>
                            <th class="px-6 py-3 text-left text-sm font-medium text-gray-700">Email</th>
                            <th class="px-6 py-3 text-left text-sm font-medium text-gray-700">Ngày đặt
                            </th>
                            <th class="px-6 py-3 text-left text-sm font-medium text-gray-700">Tổng tiền
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        <% List<Statistical> danhSachThongKe = (List<Statistical>)
                                request.getAttribute("danhSachThongKe");
                                ...
                                <% } %>
                                    <tr class="bg-gray-100">
                                        <td colspan="6"
                                            class="px-6 py-3 text-sm font-bold text-gray-700">Tổng cộng
                                        </td>
                                    ...
                                    <% } else { %>
                                        <tr>
                                            <td colspan="7"
                                                class="px-6 py-3 text-sm text-gray-700 text-center">
                                                Không có dữ liệu thống kê.</td>
                                        </tr>
                                        <% } %>
                    </tbody>
                </table>
