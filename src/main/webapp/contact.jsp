    ...
    <header class="border-b bg-white shadow-sm">
        <div class="container mx-auto flex justify-between items-center py-4 px-6">
            ...
            <div class="flex items-center space-x-6">
                <% // Kiểm tra xem người dùng đã đăng nhập hay chưa String profileLink; if
                    (session.getAttribute("user") !=null) { // Nếu đã đăng nhập, dẫn đến profile.jsp
                    profileLink="profile.jsp" ; } else { // Nếu chưa đăng nhập, dẫn đến signinup.jsp
