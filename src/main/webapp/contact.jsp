...
<body class="font-roboto bg-gray-100">
    ...
    <div class="container mx-auto p-6">
        <div class="bg-white shadow-md rounded-lg p-6">
            <h1 class="text-3xl font-bold mb-6 text-center text-blue-500">Liên Hệ</h1>
            <div class="flex flex-col md:flex-row items-center mb-6">
                <div class="md:w-1/2 mb-6 md:mb-0">
                    <img alt="A cute cartoon teddy bear holding a heart" class="rounded-lg shadow-md" height="400"
                        src="https://storage.googleapis.com/a1aa/image/2RHzJLcVQt6LGZIYkfWubWbLFRPbeaQRe1kZOH3zaR5OYIwnA.jpg"
                        width="400" />
                </div>
                <div class="md:w-1/2 md:pl-6">
                    <div class="mb-6 flex items-center">
                        <h2 class="text-xl font-semibold text-gray-800 mr-4">Tên Shop</h2>
                        <p class="text-2xl font-bold text-blue-500">JELLYCAT</p>
                    </div>
                    <div class="mb-6">
                        <h2 class="text-xl font-semibold text-gray-800">Số Điện Thoại</h2>
                        <p class="text-gray-700">
                            <i class="fas fa-phone-alt text-blue-500"></i> 0386215152
                        </p>
                    </div>
                    <div class="mb-6">
                        <h2 class="text-xl font-semibold text-gray-800">Email</h2>
                        <p class="text-gray-700">
                            <i class="fas fa-envelope text-blue-500"></i> HongSang@gmail.com
                        </p>
                    </div>
                    <div class="mb-6">
                        <h2 class="text-xl font-semibold text-gray-800">Địa Chỉ</h2>
                        <p class="text-gray-700">
                            <i class="fas fa-map-marker-alt text-blue-500"></i> 123 Đường Thành Đạt, Quận 9, TP. Hồ Chí Minh, Việt Nam
                        </p>
                    </div>
                </div>
            </div>
