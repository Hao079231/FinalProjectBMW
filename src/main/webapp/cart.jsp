...
<body class="bg-gray-100">
    <% String message=(String) session.getAttribute("message"); String error=(String)
        session.getAttribute("error"); session.removeAttribute("message");
                ...
                <% if (error !=null) { %>
                    ...
                    <% } %>
                        ...
                        <header class="bg-white shadow-lg">
                            <div
                                ...
                                <div class="flex items-center space-x-6">
                                    <a href="ProductList"
                                        class="text-gray-600 hover:text-blue-500">Trang chủ</a>
                                </div>
                            </div>
                        </header>
                        ...
                        <div class="container mx-auto py-8">
                            ...
                            <% Beans.Cart cart=(Beans.Cart) session.getAttribute("cart"); boolean
                                hasInvalidItems=false; if (cart !=null && !cart.isEmpty()) { for
                                (Map.Entry<Integer, CartItem> entry : cart.getItems().entrySet()) {
                                CartItem item = entry.getValue();
                                if (item.getQuantity() < 1 || item.getQuantity()>
                                    item.getProduct().getStock() || !item.getProduct().getStatus())
                                    {
                                    ...
                                    %>
                                    <div
                                        class="bg-yellow-600 text-white p-4 rounded-lg shadow-lg mb-6 flex items-center space-x-4">
                                        <i class="fas fa-exclamation-circle text-xl"></i>
                                        <span>Một số sản phẩm trong giỏ hàng không hợp lệ hoặc hết
                                            hàng và đã bị xóa.</span>
                                    </div>
                                    <% } %>
                                                            ...
                                                            <td class="py-2 px-4 border-b">
                                                                <form action="Cart" method="post"
                                                                    ...
                                                                    <input type="hidden"
                                                                        ...
                                                                        csrfToken") %>" />
                                                                    <button type="submit"
                                                                        class="ml-2 bg-blue-600 text-white rounded px-2 py-1">Cập
                                                                        nhật</button>
                                                                </form>
                                                            </td>
                                                            <td class="py-2 px-4 border-b">
                                                            ...
                                                            <td class="py-2 px-4 border-b">
                                                                <form action="Cart" method="post"
                                                                    ...
                                                                    <input type="hidden"
                                                                        ...
                                                                        csrfToken") %>" />
                                                                    <button type="submit"
                                                                        class="bg-red-600 text-white rounded px-2 py-1">Xóa</button>
                                                                </form>
                                                            </td>
                                                        </tr>
                                                        <% } } %>
                                        ...
                                        <div class="mt-4">
                                            <h2 class="text-xl font-bold">Tổng tiền: <%=
