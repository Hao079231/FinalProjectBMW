...
<body class="font-roboto bg-gray-100">
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="text-center">
                ...
                <p class="text-gray-600 mb-4">
                    Jellycat Store ra đời với mong muốn mang đến cho khách hàng những sản phẩm chất lượng cao cùng
                    trải nghiệm mua sắm thân thiện, hiện đại. Là một cửa hàng mới mở, chúng tôi luôn nỗ lực để xây
                    dựng uy tín và niềm tin với từng khách hàng.
                </p>
                <p class="text-gray-600 mb-4">
                    Sản phẩm của chúng tôi được chọn lọc cẩn thận để đảm bảo phù hợp với nhu cầu và sở thích đa dạng
                    của bạn. Jellycat Store hy vọng trở thành người bạn đồng hành đáng tin cậy trong cuộc sống hàng
                    ngày của bạn.
                </p>
    ...
    <section class="bg-white py-12">
        <div class="container mx-auto px-6 text-center">
            ...
            <p class="text-gray-600 mb-4">
                Từ sự tận tâm trong khâu lựa chọn sản phẩm đến dịch vụ khách hàng chuyên nghiệp, chúng tôi luôn đặt
                bạn là trọng tâm của mọi hoạt động.
                <br />
        ...
        <div class="container mx-auto px-6 flex flex-col md:flex-row items-center md:items-start">
            <div class="md:w-1/2 text-center md:text-left md:pr-8">
                ...
                <p class="text-gray-600 mb-4 leading-relaxed">
                    Jellycat Store được sáng lập bởi những con người trẻ tràn đầy nhiệt huyết, mong muốn xây dựng
                    một thương hiệu đáng tin cậy. Mỗi sản phẩm tại cửa hàng đều được kiểm tra kỹ lưỡng, mang đến sự
                    hài lòng và giá trị cho khách hàng.
                    <br><br>
                    Với phương châm "Khách hàng là trọng tâm", chúng tôi không ngừng hoàn thiện và phát triển để
                    phục vụ bạn tốt nhất. Hãy đồng hành cùng Jellycat Store trên hành trình này!
                </p>

            </div>
            <div class="md:w-1/2 mt-8 md:mt-0">
                <img src="https://storage.googleapis.com/a1aa/image/2RHzJLcVQt6LGZIYkfWubWbLFRPbeaQRe1kZOH3zaR5OYIwnA.jpg"
                    alt="Hình ảnh cửa hàng gấu bông với các loại gấu bông được trưng bày đẹp mắt"
