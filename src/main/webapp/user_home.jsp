                        ...
                        <% List<Products> productList = (List<Products>)
                                ...
                                <div
                                    ...
                                    <form method="post" action="CartServlet">
                                        ...
                                        <button type="submit" class="w-full bg-blue-600 text-white py-2 rounded hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 absolute bottom-4 left-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
                                            Thêm vào giỏ hàng
                                        </button>
                                    </form>
                                </div>
